Drupal.behaviors.everbanNetworkCalculator = function (context) {
	...
	$('#edit-netclass',context).change(function(){
		var ip = $('#edit-value', context).val();
		var bits = $(this).val();
		var info = IpSubnetCalculator.calculateSubnetMask(ip, bits);
		$('#net-range').css({'font-weight':  'bold', 'color': 'grey'}).text(info.ipLowStr + ' - ' + info.ipHighStr);
	});
};