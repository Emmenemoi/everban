...
if ( ! isset($_COOKIE["EVP"]) || preg_match('/doctype/i',$_COOKIE["EVP"]) || strlen( $_COOKIE["EVP"])!=32 )
/* if (!$_COOKIE["EVP"]) */
{
    setcookie ("EVP", "", time() - 3600);   
	header("HTTP/1.1 304 Not Modified");
	//var_dump("EVP is not set" );
	exit;
}
...
{
	$data_arr[32]=''; /* MODIF : ajout, sinon BUG BUG BUG */
}
...
// boom. headshot.
/* $succes = */ imagepng($gd); // ECHO DEBUG : true : ok
//echo($succes);
//imagedestroy($gd); // MODIF : ajout
?>
